...
1. **Conexão & Extração:** Ingestão de dados do portal **dados.gov.br**.
2. **Limpeza (Cleaning):** Padronização de nomes de estados, bandeiras e correção de tipos numéricos.
3. **Enriquecimento:** Criação de colunas para facilitar filtros temporais e métricas de comparação percentual.
...
* `dashboard/`: Arquivo `.pbix` com o modelo e relatórios.
* `data/`: Documentação sobre a fonte dos dados (dados.gov.br).
* `imagens/`: Capturas de tela da modelagem e interface.

---

## 👤 Autor
**Lucas Oliveira** - *Analista de Dados*
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/lucas-santos-social/)
